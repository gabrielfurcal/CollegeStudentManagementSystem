...
<mt:mastertemplate title="Edit role" pageName="Edit role">   
    <jsp:attribute name="content">
        ...
        <c:set var="definedPermissionsIds" scope="request" value='${requestScope["definedPermissionsIds"]}'/>
        ...
        <form method="POST" action="${pageContext.servletContext.contextPath}/Roles/Edit" class="form form-horizontal"
              id="frmEditRole">
            ...
            <div class="row">
                <div class="col-md-6">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-9">
                            <textarea class="form-control" name="roleDescription" id="roleDescription" rows="5"
                                      style="width: 100%;">${role.roleDescription}</textarea>
                        </div>
                    </div>
                    <div class="form-group row">
                        <label class="col-md-3 label-control" for="roleCreationDate">Creation date</label>
                        <div class="col-md-9">
                            <input type="text" class="form-control" name="roleCreationDate" id="roleCreationDate"
                                   value="${simpleDateFormat.format(role.roleCreationDate)}" disabled="true"/>
                        </div>
                    </div>
                </div>
                <div class="col-md-6">
                    <div class="form-group row">
                        ...
                        <div class="col-md-9" id="checkBoxSelection">
                            <table id="tablePermissionsInRoleEdit"
                                   class="table table-striped table-bordered zero-configuration" style="width:100%;"
                                   aria-describedby="tablePermissionsInRoleEdit_info" role="grid">
                                <thead>
                                <tr>
                                    <th>Name</th>
                                    <th>Select</th>
                                ...
                                <c:forEach var="permission" items="${permissions}">
                                        <tr>
                                            ...
                                            <td>
                                                <c:choose>
                                                    <c:when
                                                            test="${definedPermissionsIds.contains(permission.permissionId)}">
                                                        <input type="checkbox" value="${permission.permissionId}"
                                                               name="permissionsSelected" checked="checked"/>
                                                    </c:when>
                                                    <c:otherwise>
                                                        <input type="checkbox" value="${permission.permissionId}"
