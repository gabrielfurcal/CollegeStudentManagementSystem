...
<mt:mastertemplate title="Details student" pageName="Details student">
    <jsp:attribute name="content">
        ...
        <form method="POST" action="${pageContext.servletContext.contextPath}/Students/Delete" class="form form-horizontal" id="frmDetailsStudent">
            <c:if test="${isSuccess != null}">
                <div class="alert alert-danger">
                    An error was occurred trying to delete student
                </div>
            </c:if>       
            ...
            <div class="row">
                <div class="col-md-6">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-9">
                            <input type="text" class="form-control" name="userFirstName" value="${student.user.userFirstName}" readonly="readonly"/>
                        </div>
                    </div>
                    <div class="form-group row">
                        <label class="col-md-3 label-control" for="userFatherLastName">Father last name</label>
                        <div class="col-md-9">
                            <input type="text" class="form-control" name="userFatherLastName" value="${student.user.userFatherLastName}" readonly="readonly"/>
                        </div>
                    </div>
                    <div class="form-group row">
                        <label class="col-md-3 label-control" for="userMotherLastName">Mother last name</label>
                        <div class="col-md-9">
                            <input type="text" class="form-control" name="userMotherLastName" value="${student.user.userMotherLastName}" readonly="readonly"/>
                        </div>
                    </div>
                    <div class="form-group row">
            ...
            <div class="row">
                <div class="col-md-6">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-9">
                            <textarea class="form-control" name="addressStreetAndNumber" id="addressStreetAndNumber" rows="5" style="width: 100%;" readonly="readonly">${student.user.address.addressStreetAndNumber}</textarea>
                        </div>
                    </div>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-9">
                            <input type="text" class="form-control" name="addressNeighborhood" id="addressNeighborhood" value="${student.user.address.addressNeighborhood}" readonly="readonly"/>
                        </div>
                    </div>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-9">
                            <input type="text" class="form-control" name="addressSector" id="addressSector" value="${student.user.address.addressSector}" readonly="readonly"/>
                        </div>
                    </div>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-9">
                            <input type="text" class="form-control" name="addressMunicipality" id="addressMunicipality" value="${student.user.address.addressMunicipality}" readonly="readonly"/>
                        </div>
                    </div>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-9">
                            <input type="text" class="form-control" name="addressProvince" id="addressProvince" value="${student.user.address.addressProvince}" readonly="readonly"/>
                        </div>
                    </div>
                </div>
                <div class="col-md-6">
    ...
    <jsp:attribute name="scripts">
        ...
        <script src="${pageContext.servletContext.contextPath}/resources/scripts/studentDetailsScript.js"></script>
