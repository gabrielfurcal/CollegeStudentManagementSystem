<%-- 
    Document   : 403
    Created on : Oct 1, 2018, 4:32:41 PM
...
<html class="loading" lang="en" data-textdirection="ltr">
    <head>
      ...
      <title>Error 403 - College Student Management System
      </title>
      ...
      <link rel="stylesheet" type="text/css" href="<%= request.getContextPath()%>/resources/app-assets/css/core/menu/menu-types/vertical-menu.css">
      <link rel="stylesheet" type="text/css" href="<%= request.getContextPath()%>/resources/app-assets/css/core/colors/palette-gradient.css">
      <link rel="stylesheet" type="text/css" href="<%= request.getContextPath()%>/resources/app-assets/css/pages/error.css">
      <!-- END Page Level CSS-->
      <!-- BEGIN Custom CSS-->
    ...
    data-open="click" data-menu="vertical-menu" data-col="1-column">
              ...
              <div class="col-12 d-flex align-items-center justify-content-center">
                <div class="col-md-4 col-10 p-0">
                  ...
                  <div class="card-content">
                    <div class="row py-2">
                      <div class="col-12 col-sm-12 col-md-612">
                        <a href="<%= request.getContextPath()%>/Home" class="btn btn-primary btn-block"><i class="ft-home"></i> Back to Home</a>
                      </div>
                    </div>
                  </div>
      ...
      <script src="<%= request.getContextPath()%>/resources/app-assets/vendors/js/forms/validation/jqBootstrapValidation.js"
