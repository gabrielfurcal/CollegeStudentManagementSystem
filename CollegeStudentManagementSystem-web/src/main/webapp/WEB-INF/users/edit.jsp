...
<mt:mastertemplate title="Edit user" pageName="Edit user">
    <jsp:attribute name="content">
        ...
        <form method="POST" action="${pageContext.servletContext.contextPath}/Users/Edit" class="form form-horizontal"
              id="frmEditUser">
            ...
            <div class="row">
                <div class="col-md-6">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-9">
                            <input type="text" class="form-control" name="userFirstName" value="${user.userFirstName}"
                                   id="userFirstName"/>
                        </div>
                    </div>
                    <div class="form-group row">
                        ...
                        <div class="col-md-9">
                            <input type="text" class="form-control" name="userFatherLastName"
                                   value="${user.userFatherLastName}" name="userFatherLastName"
                                   id="userFatherLastName"/>
                        </div>
                    </div>
                    <div class="form-group row">
                        <label class="col-md-3 label-control" for="userMotherLastName">Mother last name</label>
                        <div class="col-md-9">
                            <input type="text" class="form-control" name="userMotherLastName" id="userMotherLastName"
                                   value="${user.userMotherLastName}"/>
                        </div>
                    </div>
                    <div class="form-group row">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-9">
                            <div class="row">
                                ...
                                <div class="col-md-2">
                                    <input type="button" class="btn btn-default pull-right" id="newPasswordSetter"
                                           onclick="allowNewPasswordField()" value="Set"/>
                                </div>
                            </div>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-9">
                            <input type="text" class="form-control" id="userEmail" name="userEmail" value="${email}"/>
                        </div>
                    </div>
                </div>
                <div class="col-md-6">
                        ...
                        <c:forEach items="${telephones}" var="telephone" varStatus="index">
                            <div class="form-group row" id="divTelephone${index.count - 1}">
                                ...
                                <div class="col-xl-7 col-md-6">
                                    <select class="form-control select-telephone" id="selectTelephone${index.count - 1}"
                                        ...
                                        <c:forEach var="telephoneType" items="${telephoneTypes}">
                                            <c:choose>
                                                <c:when test="${telephoneType.telephoneTypeId.toString().equals(telephone.telephoneType.telephoneTypeId.toString())}">
                                                    <option value="${telephoneType.telephoneTypeId.toString()}"
                                                            selected="true">${telephoneType.telephoneTypeName}</option>
                                                </c:when>
                                                <c:otherwise>
                                    ...
                                    <input type="text" class="form-control " id="telephone${index.count - 1}"
                                           name="telephones" value="${telephone.telephoneNumber}"/>
                                    <input type="hidden" id="hiddenTelephoneId${index.count - 1}" name="telephoneId"
                                           value="${telephone.telephoneId.toString()}"/>
                                </div>
                                <div class="col-xl-2 col-md-3">
                                    <input type="button" style="width:100%;" id="btnDeleteTelephone${index.count - 1}"
                                           onclick="deleteTelephone('divTelephone${index.count - 1}', ${telephone.telephoneId.toString()}, '${pageContext.servletContext.contextPath}/Telephones/Delete')"
                                           value="Delete" class="btn btn-danger pull-right"/>
                                </div>
                            </div>
                        </c:forEach>
                    </div>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-3 col-lg-3 col-xl-2" style="text-align: right;">
                            <input type="button" id="addTelephone" value="+ Add" class="btn btn-default pull-right" style="width: 100%;" onclick="addNewTelephone('${pageContext.servletContext.contextPath}/Telephones/Types')"/>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="col-md-6">
                    ...
                    <div class="form-group row">
                        <input type="hidden" name="addressLatitude" id="addressLatitude"
                               value="${user.address.addressLatitude}"/>
                        <input type="hidden" name="addressLongitude" id="addressLongitude"
                               value="${user.address.addressLongitude}"/>
                        <label class="col-md-3 label-control">Search in map</label>
                        <div class="col-md-9">
                            <div class="row">
                                <div class="col-md-10">
                                    <input type="text" class="form-control" id="addressBrowser" onfocus="geolocate()"
                                           placeholder="Enter an address"/>
                                </div>
                                <div class="col-md-2">
                                    <input type="button" class="btn btn-default pull-right" id="enableBrowser"
                                           onclick="enableAddressBrowser()" value="Enable"/>
                                </div>
                            </div>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-9">
                            <textarea class="form-control" name="addressStreetAndNumber" id="addressStreetAndNumber"
                                      rows="5" style="width: 100%;">${user.address.addressStreetAndNumber}</textarea>
                        </div>
                    </div>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-9">
                            <input type="text" class="form-control" name="addressNeighborhood" id="addressNeighborhood"
                                   value="${user.address.addressNeighborhood}"/>
                        </div>
                    </div>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-9">
                            <input type="text" class="form-control" name="addressSector" id="addressSector"
                                   value="${user.address.addressSector}"/>
                        </div>
                    </div>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-9">
                            <input type="text" class="form-control" name="addressMunicipality" id="addressMunicipality"
                                   value="${user.address.addressMunicipality}"/>
                        </div>
                    </div>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-9">
                            <input type="text" class="form-control" name="addressProvince" id="addressProvince"
                                   value="${user.address.addressProvince}"/>
                        </div>
                    </div>
                </div>
                <div class="col-md-6">
                                ...
                                <c:forEach var="position" items="${positions}">
                                    <c:choose>
                                        <c:when test="${position == user.position}">
                                            <option value="${position.positionId.toString()}"
                                                    selected="true">${position.positionName}</option>
                                        </c:when>
                                        <c:otherwise>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-9">
                            <table id="tableRolesInUserEdit"
                                   class="table table-striped table-bordered zero-configuration" style="width:100%;"
                                   aria-describedby="tableRolesInUserEdit_info" role="grid">
                                <thead>
                                <tr>
                                    <th>Name</th>
                                    <th>Description</th>
                                            ...
                                            <c:choose>
                                                <c:when test="${definedRoles.contains(role)}">
                                                    <td><input type="checkbox" value="${role.roleId}"
                                                               name="rolesSelected" checked="checked"/></td>
                                                </c:when>
                                                <c:otherwise>
                                                    <td><input type="checkbox" value="${role.roleId}"
                                                               name="rolesSelected"/></td>
                                                </c:otherwise>
                                            </c:choose>
                                        </tr>
                                    </c:forEach>
    ...
    <jsp:attribute name="scripts">
        ...
        <script src="https://maps.googleapis.com/maps/api/js?key=AIzaSyBMMDeX_IkhAKnk549y9aZ0L4Kvh6dOB6o&libraries=places&callback=initAutocomplete"
                async defer></script>
    </jsp:attribute>
</mt:mastertemplate>