...
<mt:mastertemplate title="Create teacher" pageName="New teacher">
    <jsp:attribute name="content">
        ...
        <form method="POST" action="${pageContext.servletContext.contextPath}/Teachers/Create" class="form form-horizontal" id="frmCreateTeacher">
            <c:if test="${isSuccess != null}">
                <div class="alert alert-danger">
                    An error was occurred trying to create teacher
                </div>
            </c:if>      
            <div class="row">
                <div class="col-md-6">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-9">
                            <input type="text" class="form-control" name="userFirstName" id="userFirstName" onchange="createUsername()"/>
                        </div>
                    </div>
                    <div class="form-group row">
                        <label class="col-md-3 label-control" for="userFatherLastName">Father last name</label>
                        <div class="col-md-9">
                            <input type="text" class="form-control" name="userFatherLastName" id="userFatherLastName" onchange="createUsername()"/>
                        </div>
                    </div>
                    <div class="form-group row">
    ...
    <jsp:attribute name="scripts">
        ...
        <script src="${pageContext.servletContext.contextPath}/resources/scripts/teacherCreateScript.js"></script>
