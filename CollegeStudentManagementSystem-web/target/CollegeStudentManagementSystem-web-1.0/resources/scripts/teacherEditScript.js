...
$(document).ready(() => {
    ...
    $('#usernameValidator').attr("disabled", "true");
});
...
function createUsername(oldUsername) {
    ...
    let newUsername = firstLetterName.toLowerCase() + fatherLastName.toLowerCase();
    
    $('#userUsername').val(newUsername);
    
    if(oldUsername !== newUsername) {
        $('#usernameValidator').removeAttr("disabled");        
    } else {
        $('#usernameValidator').attr("disabled", "true");
    }
}

function activateCheckButton(e, oldValue) {
